...
\var{\Peneliti}{IKHSAN MOCHAMMAD NOOR}
\var{\nim}{1157030026}
\var{\judul}{Mekanisme Flocking Partikel pada Gerakan Tawaf}
\Var{\Judul}{MEKANISME FLOCKING PARTIKEL PADA GERAKAN TAWAF}
\var{\named}{\textit{PARTICLE FLOCKING MECHANISM IMPLEMENTED
IN THE TAWAF MOVEMENT 
...
\var{\Alat}{}
\author{\peneliti}
\title{PARTICLE FLOCKING MECHANISM IMPLEMENTED
IN THE TAWAF MOVEMENT 
USING THE RUNGE KUTTA METHOD}
%\title{\centering}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{file/cover}
\pagenumbering{roman}
\input{file/pernyataan}
\input{file/persetujuan}
\input{file/pengesahan}
\input{file/persembahan}
\input{file/abstrak}
\input{file/abstract}
\input{file/pengantar}
\input{file/daftar}
\input{file/singkatan}
\input{file/simbol}
%ISI
\input{file/pendahuluan}%bab 1
\input{file/teori}%bab 2
\input{file/metodologi}%bab 3
\input{file/hasil}%bab 4
\input{file/penutup}%bab 5
\cleardoublepage
\phantomsection
