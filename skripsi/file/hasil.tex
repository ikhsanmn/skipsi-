...
% heavy congestion is made at the beginning of the queue.Without adding physical interactions, we cannot capture the effect
% of crowd force applied to these agents even in such high density. Agents are stuck in the beginning of the queue although
% there is a space in front of the queue to proceed. By adding
% physical interactions, the agents in the queue are pushed by
% the crowds, and move towards the black stone without breaking the queue.
