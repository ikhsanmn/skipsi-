...
\hfill
\subfigure[Grafik Model Flocking dengan range 25 N=100]{\label{fig:grafik flocking dengan range 25}\includegraphics[scale=0.45]{gambar/datagrafik/range25homogennoflocking}}
...
\hfill
\subfigure[Grafik Model Flocking dengan range 50 N=100]{\label{fig:grafik flocking dengan range 50}\includegraphics[scale=0.45]{gambar/datagrafik/range50noflocking}}
...
\hfill
\subfigure[Grafik Model Flocking dengan gaya dominan, range 25 N=100]{\label{fig:grafik flocking dengan gaya dominan range 25}\includegraphics[scale=0.45]{gambar/datagrafik/range25homogen}}
\hfill
\subfigure[Grafik Model Flocking dengan gaya dominan range 50 N=100]{\label{fig:grafik flocking dengan gaya dominan range 50}\includegraphics[scale=0.45]{gambar/datagrafik/range50homogen}}
\end{figure}
...
\hfill
\subfigure[Grafik Model Flocking dengan range 25 N=100 gaya dominan tawaf]{\label{fig:flocking dengan range 25 dominan force}\includegraphics[scale=0.45]{gambar/datagrafik/range25heterogen}}
...
\hfill
\subfigure[Grafik Model Flocking dengan range 50 N=100 gaya dominan tawaf]{\label{fig:flocking dengan range 50 dominan force}\includegraphics[scale=0.45]{gambar/datagrafik/range50heterogen}}
